...
public class PlotDialog extends TableDialog {
		...
		public void actionPerformed(ActionEvent e) {
			...
			Graph graph = new Graph(file, title);
			graph.pasteToTextFrame(MainInterface.codeField, graph.makeElementCode());
			dispose();
